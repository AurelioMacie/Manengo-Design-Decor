...
public class StockMDI extends javax.swing.JInternalFrame {
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        ...
        if (jTextFieldId.getText().isEmpty()){
            JOptionPane.showMessageDialog(null, "Seleciona Um dos Produtos Da Tabela Para Continuar!");
            
        }else  if (jTextFieldAdicionar.getText().isEmpty()){
            JOptionPane.showMessageDialog(null, "Seleciona Um dos Produtos E Preencha O Campo 'Qtd Adicionar' Para Continuar!");
